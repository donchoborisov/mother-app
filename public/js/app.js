...
// Vue.component('advert-create', require('./components/AdvertCreate.vue').default);
...
app.component('advert-create', AdvertCreate);
app.mount('#app');
